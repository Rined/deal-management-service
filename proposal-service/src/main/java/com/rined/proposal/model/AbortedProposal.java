...
@Data
@Document("aborted_proposal")
@NoArgsConstructor
@AllArgsConstructor
public class AbortedProposal {
    ...
    public AbortedProposal(String proposalName, List<ProposalField> fields, String templateFormat, String providerId) {
