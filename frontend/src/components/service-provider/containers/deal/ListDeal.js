...
import {useActionSetter} from "./../../../contexts/DealContext";
            ...
            <Paper style={{marginTop: 10}}>
                <List component="nav">
                    {deals && deals.map((deal, i) => (
                        <ListItem key={i} onClick={() => handleView(deal.id)} button>
                            <ListItemText primary={deal.name}/>
                            <ListItemSecondaryAction>
                                <IconButton edge="end" onClick={() => handleEdit(deal.id)} aria-label="edit">
